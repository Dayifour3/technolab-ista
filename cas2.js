...
/*Fin Fonction Pour verifier si une matière est validé ou pas*/
        ...
        /* Obtenir le nom et le prenom de l'élève*/
            ...
            if(sek === 0){
                ...
                for(i=4;i<jsonData.length; i++){
                    if(countProperty(i)===11){
                        if(verifier_la_validite(i)!==""){
                            ...
                            bloque_i=1;
                            if(jsonData[i+1].__EMPTY_1 >= 10 || jsonData[i+2].__EMPTY_1 >= 10){
                ...
                var modules = []
                for(let i=new_debut;i<jsonData.length; i++){
                    if(countProperty(i)===11){
                        if(verifier_la_validite(i)!==""){
                            tab_de_matiere_non_valide.push(verifier_la_validite(i));
                        }
            ...
            worksheet[sek].getColumn(1).width = 4
            worksheet[sek].getColumn(2).width = 25
            worksheet[sek].getColumn(3).width = 15
            worksheet[sek].getColumn(4).width = 16
            worksheet[sek].getColumn(5).width = 30
                ...
                if(sek === 0){
                    worksheet[sek].getRow(3).values = ["RESULTAT DE LA PREMIERE SESSION"];
                }
                else if(sek === 1){
